...
public AutoHeuristicTSP( String title, int ulx, int uly, int pw, int ph, String filePath )
{
 super(title,ulx,uly,pw,ph);

 try{
   String fileName = filePath.substring(filePath.lastIndexOf('\\') + 1, filePath.lastIndexOf(".txt"));
